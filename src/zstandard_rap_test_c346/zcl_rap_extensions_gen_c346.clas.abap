CLASS zcl_rap_extensions_gen_c346 DEFINITION
INHERITING FROM ZCL_RAP_EXTENSIONS_BASE_C346
  PUBLIC
  CREATE PUBLIC .
  ...
  PROTECTED SECTION.
    ...
    CONSTANTS:
      co_prefix                     TYPE string           VALUE 'ZUSEREXT',
      co_suffix                     TYPE string           VALUE 'USER',
      co_entity_name                TYPE string           VALUE 'Shop',
      co_session_name               TYPE string           VALUE 'USER_EXT',
...
CLASS zcl_rap_extensions_gen_c346 IMPLEMENTATION.
